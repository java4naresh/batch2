...
System.out.println("6*2="+(5*2));
System.out.println("6*3="+(5*3));
System.out.println("6*4="+(5*4));
System.out.println("6*5="+(5*5));
System.out.println("6*6="+(5*6));
System.out.println("6*7="+(5*7));
System.out.println("6*8="+(5*8));
System.out.println("6*9="+(5*9));
System.out.println("6*10="+(5*10));
break;
case 7:
